...
div(class="xl:min-h-[calc(100vh-136px)] overflow-hidden")
  ...
  xl:justify-end")
    ...
    div(class="flex flex-col mt-[34px] sm:mt-[56px] xl:mb-[229px]")

      nav(class="gap-4 flex m-auto xl:absolute xl:-mb-[145px] xl:ml-[167px] \
      xl:gap-[14px]")
        router-link(
          ...
          sm:h-[60px] xl:w-[25px] xl:h-[25px] text-white")
          span(class="font-bellefair mt-[2px] sm:text-2xl") {{ i + 1 }}
